...
const ShouldIBuyModal = ({ productId, isOpen, onClose, openCompareModal }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 md:p-10 z-50">
      <div className="bg-[#101110] rounded-lg p-4 md:p-6 lg:p-8 w-full max-w-2xl relative flex flex-col items-center">
        <button
        ...
        {analysisResult ? (
          <>
            <p className="text-base md:text-lg lg:text-xl text-center mb-4 md:mb-6">
              {analysisResult}
            </p>
            {/* Show "Compare this product" button only if the result is not one of the two specific messages */}
            {analysisResult !==
