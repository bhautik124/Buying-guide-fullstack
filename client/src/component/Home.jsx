  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="relative z-10 w-full h-full flex items-center justify-center text-center px-4">
          <div className="px-4 md:px-8 py-4 md:py-6 rounded-lg">
            <h1 className="font-extrabold leading-tight text-white">
              <span className="block text-[10vw] sm:text-[12vw] md:text-[14vw] leading-none">
                SHOP
              </span>
              <span className="block text-[10vw] sm:text-[12vw] md:text-[14vw] leading-none">
                THE BEST
            ...
            <p className="text-lg md:text-xl lg:text-2xl xl:text-3xl text-white mt-4 max-w-3xl mx-auto">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim,
              odio!
            </p>
          </div>
      ...
      {/* second section */}
      <div className="w-full h-screen flex flex-col items-center justify-end mt-[-5%] pb-10 px-4">
        ...
        <Magnet
          ...
          disabled={false}
          magnetStrength={5}
          wrapperClassName="border border-white p-3 md:p-4 text-white rounded-lg cursor-pointer text-sm md:text-base"
        >
          <Link to="/product">
            <p>Browse Products!</p>
          </Link>
      ...
      {/* third section */}
      <div className="w-full min-h-screen text-white flex flex-col justify-center items-center font-bold text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-9xl relative overflow-hidden py-10">
        <div className="text-center leading-none px-4">
          <div>
            <DecryptedText
              text="CONTACT US"
              animateOn="view"
        ...
        <div className="absolute bottom-4 md:bottom-10 w-full flex flex-wrap justify-center md:justify-between px-4 md:px-10 text-xs sm:text-sm md:text-base lg:text-lg gap-2 md:gap-0">
          <span className="underline mx-2">PROJECT INQUIRIES</span>
          <span className="underline mx-2">LEE@SIENA.FILM</span>
          <span className="underline mx-2">PHONE NUMBER</span>
          <span className="underline mx-2">+972-54-2804049</span>
        </div>
      </div>
    </div>
  );
