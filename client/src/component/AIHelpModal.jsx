  ...
  return (
    isAIOpen && (
      <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 md:p-10 z-50">
        <div className="bg-[#101110] rounded-lg p-4 md:p-6 lg:p-8 w-full max-w-2xl md:max-w-3xl lg:max-w-4xl relative max-h-[90vh] overflow-y-auto">
          <button
            className="absolute top-2 right-2 md:top-4 md:right-4 text-white text-xl md:text-2xl"
            onClick={() => setIsAIOpen(false)}
          >
            &times;
          </button>
          <h3 className="text-xl md:text-2xl font-bold mb-4">AI Help</h3>
          <div className="flex flex-col space-y-4">
            {!selectedQuestion && (
              <div className="space-y-2 md:space-y-4">
                {categoryQuestions[product.category]?.map((question, index) => (
                  <button
                    key={index}
                    className="w-full bg-[#202020] px-3 py-2 md:px-4 md:py-2 rounded-lg text-base md:text-lg lg:text-xl hover:bg-[#303030]"
                    onClick={() => handleAIClick(question)}
                  >
                    {question}
                  </button>
            ...
            {selectedQuestion && (
              <div className="flex flex-col space-y-4">
                <div className="flex justify-end">
                  <div className="bg-[#202020] px-3 py-2 md:px-4 md:py-2 rounded-lg text-base md:text-lg lg:text-xl max-w-[90%] md:max-w-[70%]">
                    {selectedQuestion}
                  </div>
                </div>
                <div className="flex justify-start">
                ...
                <div className="flex justify-center">
                  <button
                    className="bg-[#202020] px-3 py-2 md:px-4 md:py-2 rounded-lg text-base md:text-lg lg:text-xl hover:bg-[#303030]"
                    onClick={resetAI}
                  >
                    Reset
                  </button>
